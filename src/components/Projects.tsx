  ...
  const projects: Project[] = [
    {
      ...
      gradient: 'from-slate-900 to-slate-700',
        mediaBlocks: [
        {
          image: asset('projects/laptop.avif'),
        },
      ],
    },
    {
    ...
    },
    {
      ...
      gradient: 'from-slate-900 to-slate-700',
        mediaBlocks: [
        {
          image: asset('projects/work.avif'),
        },
      ],
    },
    {
      ...
      gradient: 'from-slate-900 to-slate-700',
        mediaBlocks: [
        {
          image: asset('projects/image.avif'),
        },
      ],
    },
    
    {
      ...
      mediaBlocks: [
        {
          image: asset('projects/port.avif'),
        },
      ],
    },
  ];
            ...
            return (
              <Reveal key={idx} delay={idx * 80}>
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center opacity-0 translate-y-10 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-700 p-4">
                  <h4 className="text-white text-xl font-bold mb-4">Technologies Used</h4>
